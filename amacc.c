...
int *codegen(int *jitmem, int *jitmap, int reloc)
{
    ...
    while (pc <= e) {
        ...
        switch (i) {
            ...
            case ENT:
                *je++ = 0xe92d4800;
                *je++ = 0xe28db000; // push {fp, lr}; add  fp, sp, #0
                tmp = *pc++;
                if (tmp) *je++ = 0xe24dd000 | (tmp * 4); // sub  sp, sp, #(tmp * 4)
                if (tmp >= 64 || tmp < 0) {
            ...
            case LEV:
                *je++ = 0xe28bd000;
                *je++ = 0xe8bd8800; // add sp, fp, #0; pop {fp, pc}
                break;
            case LI:
            ...
            case LC:
                *je++ = 0xe5d00000;
                if (neg_int < 0)  *je++ = 0xe6af0070; // ldrb r0, [r0]; (sxtb r0, r0)
                break;
            case SI:
                *je++ = 0xe49d1004;
                *je++ = 0xe5810000; // pop {r1}; str r0, [r1]
                break;
            case SC:
                *je++ = 0xe49d1004;
                *je++ = 0xe5c10000; // pop {r1}; strb r0, [r1]
                break;
            case PSH:
            ...
            case OR:
                *je++ = 0xe49d1004;
                *je++ = 0xe1810000; // pop {r1}; orr r0, r1, r0
                break;
            case XOR:
                *je++ = 0xe49d1004;
                *je++ = 0xe0210000; // pop {r1}; eor r0, r1, r0
                break;
            case AND:
                *je++ = 0xe49d1004;
                *je++ = 0xe0010000; // pop {r1}; and r0, r1, r0
                break;
            case SHL:
                *je++ = 0xe49d1004;
                *je++ = 0xe1a00011; // pop {r1}; lsl r0, r1, r0
                break;
            case SHR:
                *je++ = 0xe49d1004;
                *je++ = 0xe1a00051; // pop {r1}; asr r0, r1, r0
                break;
            case ADD:
                *je++ = 0xe49d1004;
                *je++ = 0xe0800001; // pop {r1}; add r0, r0, r1
                break;
            case SUB:
                *je++ = 0xe49d1004;
                *je++ = 0xe0410000; // pop {r1}; sub r0, r1, r0
                break;
            case MUL:
                *je++ = 0xe49d1004;
                *je++ = 0xe0000091; // pop {r1}; mul r0, r1, r0
                break;
            case CLCA:
                *je++ = 0xe59d0004;
                *je++ = 0xe59d1000; // ldr r0, [sp, #4]
                // ldr r1, [sp]
                *je++ = 0xe3a0780f;
                *je++ = 0xe2877002; // mov r7, #0xf0000
                // add r7, r7, #2
                *je++ = 0xe3a02000;
                *je++ = 0xef000000; // mov r2, #0
                // svc 0
                break;
            default:
                if (EQ <= i && i <= GE) {
                    *je++ = 0xe49d1004;
                    *je++ = 0xe1510000; // pop {r1}; cmp r1, r0
                    if (i <= NE) {
                        je[0] = 0x03a00000;    // moveq r0, #0; movne r0, #0
                        je[1] = 0x13a00000;
                    } else if (i == LT || i == GE) {
                        je[0] = 0xb3a00000;    // movlt r0, #0; movge   r0, #0
                        je[1] = 0xa3a00000;
                    } else {
                        je[0] = 0xc3a00000;    // movgt r0, #0; movle r0, #0
                        je[1] = 0xd3a00000;
                    }
...
int elf32(int poolsz, int *start)
{
    ...
    *o++ = 0;
    *o++ = 5;
    *o++ = 0; // e_phentsize & e_phnum
    *o++ = 40;
    *o++ = 0;
    *o++ = 12;
    *o++ = 0; // e_shentsize & e_shnum
    *o++ =  1;
    *o++ = 0;

    phdr = o;
    o = o + PHDR_SIZE * 4; // e_phentsize * e_phnum for phdr size
    ...
    *(int *) entry = (int) code_addr;
    ...
    linker = data;
    memcpy(linker, "/lib/ld-linux-armhf.so.3", 25);
    linker_off = pt_dyn_off + pt_dyn_size;
    data = data + 25;
    ...
    libc = data = data +  1;
    memcpy(data, "libc.so.6", 10);
    ldso = data = data + 10;
    memcpy(data, "libdl.so.2", 11);
    data = data + 11;
    sym = data;
    ...
    *(int *) to =  6;
    to = to + 4;
    *(int *) to = (int) dynsym_addr + code_size_align;
    to = to + 4;
    *(int *) to = 11;
    to = to + 4;
    *(int *) to = 16;
    ...
    *(int *) to =  3;
    to = to + 4;
    *(int *) to = (int) got_addr + code_size_align;
    to = to + 4;
    *(int *) to =  2;
    to = to + 4;
    *(int *) to = rel_size;
    ...
    *(int *) to =  1;
    to = to + 4;
    *(int *) to = libc - dynstr_addr;
    to = to + 4;
    *(int *) to =  1;
    to = to + 4;
    *(int *) to = ldso - dynstr_addr;
    to = to + 4;
    *(int *) to =  0;
    to = to + 8;
